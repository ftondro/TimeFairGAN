...
class Options():
    ...
    def __init__(self):
        ...
        # with_fairness
        self.with_fairness.add_argument('--df_name', type=str, help='Dataframe name', default='Robot')
        ...
        self.with_fairness.add_argument('--iteration', type=int, help='Number of training iterations', default=10000)
        self.with_fairness.add_argument('--S', type=str, help='Protected attribute', default='Region')
        self.with_fairness.add_argument('--Y', type=str, help='Label (decision)', default='Failure')
        self.with_fairness.add_argument('--underprivileged_value', type=str, help='Value for underprivileged group', default='Urban')
        ...
        self.with_fairness.add_argument('--fake_name', type=str, help='Name of the produced csv file', default='Synthetic_Robot')
        ...
        self.with_fairness.add_argument('--model', type=str, default='TimeGAN_Fair', help='chooses which model to use timegan')
        ...
        self.with_fairness.add_argument('--w_g_f', type=float, default=0.49, help='Generator fair loss weight') 

        # no_fairness
        self.no_fairness.add_argument('--df_name', type=str, help='Dataframe name', default='Robot')
        ...
        self.no_fairness.add_argument('--iteration', type=int, help='Number of training iterations', default=10000)
        self.no_fairness.add_argument('--metric_iteration', type=int, help='Number of iterations for metric computation', default= 10)
        self.no_fairness.add_argument('--fake_name', type=str, help='Name of the produced csv file', default='Synthetic_Robot')
